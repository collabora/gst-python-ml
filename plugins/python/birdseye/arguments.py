...
class ArgumentsBase(object):
    ...
    def main_args_initialization(self):
        ...
        self.parser.add_argument(
            "--source", type=str, default="inference/input/test.mp4", help="source"
        )
        self.parser.add_argument(
            "--output", type=str, default="inference/output", help="output folder"
        )
        self.parser.add_argument(
            "--conf-thresh", type=float, default=0.5, help="object confidence threshold"
        )
        self.parser.add_argument(
            "--iou-thresh", type=float, default=0.5, help="IOU threshold for NMS"
        )
        self.parser.add_argument("--view", action="store_true", help="display results")
        self.parser.add_argument("--save", action="store_true", help="display results")
        self.parser.add_argument(
            "--outputfps", type=int, default=20, help="Output Video FPS"
        )
    ...
    def perspective_transform_initialization(self):
        ...
        self.parser.add_argument(
            "--fineSize", type=int, default=1024, help="then crop to this size"
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            ...
            default=os.path.join(
                self.base_path,
                "weights/pytorch-two-GAN-models/soccer_seg_detection_pix2pix",
            ),
        ...
        self.parser.add_argument(
            "--how_many", type=int, default=1, help="how many test images to run"
        )
