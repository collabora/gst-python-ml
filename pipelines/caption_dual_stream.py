...
pipeline_desc = """
  ...
  mux. ! pyml_caption name=cap device=cuda:0 downsampled_width=320 downsampled_height=240 prompt="What is the name of the game being played?" ! pyml_streamdemux name=demux
